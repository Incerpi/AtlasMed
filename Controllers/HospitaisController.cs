...
namespace AtlasMed_GS.Controllers
{
    public class HospitaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdHospital,Nome,Telefone,Endereco,Numero,Bairro,Cidade,Estado,Cep")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdHospital,Nome,Telefone,Endereco,Numero,Bairro,Cidade,Estado,Cep")] Hospital hospital)
        {
