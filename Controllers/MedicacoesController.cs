...
namespace AtlasMed_GS.Controllers
{
    public class MedicacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMedicacao,Nome,Descricao,PrincipioAtivo,Dose,Dosagem")] Medicacao medicacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMedicacao,Nome,Descricao,PrincipioAtivo,Dose,Dosagem")] Medicacao medicacao)
        {
